...
public class WXBizMsgCrypt {
	 ...
	 * @param timeStamp 时间戳，对应URL参数的timestamp
	 * @param nonce 随机串，对应URL参数的nonce
	 * @param encrypt 密文，对应POST请求的加密数据
	 * 
	 * @return 解密后的原文
	 * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
	 */
	public String newDecryptMsg(String msgSignature, String timeStamp, String nonce, String encrypt)
			throws AesException {
...
//		String result = decrypt(encrypt[1].toString());
	...
	/**
	 * 检验xml消息的真实性，并且获取解密后的明文xml对应的map.
	 * @param msgSignature
	 * @param timeStamp
	 * @param nonce
	 * @param encrypt
	 ...
	 * @throws AesException
	 */
	public Map<String,String> newDecryptXMLMsg(String msgSignature, String timeStamp, String nonce, String encrypt)
			throws AesException {
...
//		String result = decrypt(encrypt[1].toString());
		String result = decrypt(encrypt);
		return XMLParse.parseXMLString(result);
	}
