...
<form:form action="${ctx}/${iniMap.classRequestMapping}/dofeedback" onsubmit="return check()"
...
<tr><td colspan="2"><form:input path="feedback" readonly="false"/></td></tr>
<tr><td>日期</td><td><form:input path="feedbackDate" type="date" readonly="false"/></td></tr>
</c:if>
